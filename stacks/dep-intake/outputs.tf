...
output "workload_network_id" {
  description = "Resource ID of the zone workload VPC, bound by the zone's workload job."
  value       = module.network.workload_network_id
}

output "workload_subnetwork_id" {
  description = "Resource ID of the zone workload subnetwork, bound by the zone's workload job."
  value       = module.network.workload_subnetwork_id
}

output "break_glass_recovery_service_account_email" {
  description = "Email of the time-bound recovery identity of the intake zone (dep-break-glass-recovery)."
  value       = module.recovery.service_account_email
}

output "break_glass_recovery_entitlement_name" {
  description = "Resource name of the recovery entitlement of the intake zone — the activation, approval and read-back surface of the recovery drill."
